...
public class juegonormal {
	...
	private boolean revelado;
	 int contador=195;
	public juegonormal(int sizetabla, int numMinas) {
	 ...
	 System.out.println("                               ");
      ...
      if(resp==1){
    	  ...
    	  if (fila>14 && columna>14){
    		 System.out.println("no puede exeder el numero de filas 14 ni columnas 8"); 
    		 leerteclado();
    	  }
    	  else if (fila<0 &&columna <0){
    		  System.out.println("no puede exeder el numero de filas 14 ni columnas 14"); 
     		 leerteclado();
    	  }
